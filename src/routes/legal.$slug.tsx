...
const legal: Record<LegalSlug, {
  ...
  privacy: {
    ...
    meta: { en: "GastroPos privacy policy — how we collect, use and protect your data under GDPR.", de: "Datenschutzerklärung von GastroPos — wie wir Ihre Daten gemäß DSGVO erheben, nutzen und schützen." },
    body: {
  ...
  terms: {
    ...
    meta: { en: "GastroPos terms of service — the agreement that governs use of our cloud POS platform.", de: "GastroPos Allgemeine Geschäftsbedingungen — die Vereinbarung über die Nutzung unserer Cloud-Kassenplattform." },
    body: {
  ...
  impressum: {
    ...
    meta: { en: "Legal imprint for GastroPos GmbH as required by German law (§5 TMG).", de: "Impressum der GastroPos GmbH gemäß § 5 TMG." },
    body: {
  ...
  cookies: {
    ...
    meta: { en: "How GastroPos uses cookies and similar technologies on our website and product.", de: "Wie GastroPos Cookies und ähnliche Technologien auf unserer Webseite und im Produkt nutzt." },
    body: {
    ...
    <SiteShell>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-6">
          <pre className="whitespace-pre-wrap font-sans text-base leading-relaxed text-muted-foreground">{lang === "de" ? doc.body.de : doc.body.en}</pre>
        </div>
      </section>
    </SiteShell>
  );
