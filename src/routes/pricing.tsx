  ...
  head: () => ({
    meta: [
      { title: "Pricing — GastroPos Cloud POS from €39/month" },
      {
        name: "description",
        content:
          "Simple, transparent pricing. Every feature in every plan — only line-item limits differ. Klein €39, Standard €59, Premium €79 per month.",
      },
      { property: "og:title", content: "Pricing — GastroPos Cloud POS" },
      {
        property: "og:description",
        content:
          "Every feature in every plan. €39, €59 or €79 per month. No setup fee, cancel anytime.",
      },
  ...
  return (
    <SiteShell>
      <SubPageHero
        ...
        lede={
          lang === "de"
            ? "Jede Funktion ist in jedem Paket enthalten. Nur die Anzahl der Positionen pro Monat unterscheidet sich. Wir zählen die Positionen in einer Bestellung — nicht die Bestellung selbst."
            : "Every feature is included in every plan. Only the number of line items per month differs. We count the line items in an order — not the order itself."
        }
      />
